 ...
 */
package com.qubit.solution.fenixedu.cas.strategies.iseg;
...
public class ISEGTicketValidationStrategy implements TicketValidationStrategy {

    private static final Logger logger = LoggerFactory.getLogger(ISEGTicketValidationStrategy.class);
